...
/**
 * Tokenizer linearizes AST to tokens.
 * 
 * @author Zdenek Tronicek, tronicek@tarleton.edu
 */
public class Tokenizer extends VoidVisitorAdapter<Void> {

    private final boolean treatArrayDeclEqual;
    private final RenameStrategy rs = new RenameStrategy();
    private final List<String> labels = new ArrayList<>();

    public Tokenizer(Properties conf) {
